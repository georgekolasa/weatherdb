      ...
      <div style={{ padding: '15px' }}>
        ...
        <div className="container">
          <p>
            ...
            Climatological Survey, a record of daily weather recordings from
            over 115,000 weather stations around the globe.
          </p>
        </div>
        <br></br>
        <ExampleQuery />
        ...
        <div className="container">
          <p>
            ...
            phenomena, WeatherDB brings the data to you, allowing you to
            customize your data selection and visualization.
          </p>
        </div>
        <br></br>
        <div className="container">
          <p>
            ...
            trend, including meta-analysis of the data and other key features.
            The highlights only focus on the important topics, so you can gain
            an accurate understanding of the trend instantly.
          </p>
        </div>
        <br></br>
        ...
        <div className="container" style={{ flexDirection: 'column' }}>
          ...
          <p>
            NOAA releases all of their data in .dly files, which are fixed
            length blocks of data without any delimeters. Characters within
            ...
            construct SQL INSERT queries for each of these objects. These can be
            found{' '}
            <a href="https://github.com/weatherdb/weatherdb/tree/main/utils">
              here.
            </a>
          </p>
        </div>
